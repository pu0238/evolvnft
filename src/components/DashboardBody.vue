<template>
  <DashboardMenu client:only />
  <DashboardContainer client:only>
    <div v-if="location.hash === '#dashboard' || location.hash === ''">
      <h1 class="text-5xl xl:text-6xl font-cal text-black w-full">dashboard</h1>
